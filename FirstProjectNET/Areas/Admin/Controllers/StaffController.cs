using FirstProjectNET.Areas.Admin.Common;
    ...
    public class StaffController : Controller
    {
        ...
        public IActionResult Create([Bind("StaffID,FirstName,LastName,Gender,Email,Phone,Address,Role")] Staff staff)
        {
            if (ModelState.IsValid)
            {
                ...
                while (true)
                {
                    Account account = Generate.GenerateAccount(fullName, staff.Role != Role.Manager ? AccountType.Staff : AccountType.Admin,email);
