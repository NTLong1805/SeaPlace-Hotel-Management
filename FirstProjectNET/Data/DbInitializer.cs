	...
	public class DbInitializer
	{
		...
		private static Staff[] InitStaff()
		{
			var staffs = new Staff[]
			{
				...
				new Staff { StaffID = "S0002",	FirstName = "Tran",		LastName = "Duc Hai",		Gender = Gender.Male,	Address = "Thai Binh",	Email = "hai221230825@lms.utc.edu.vn",		Phone = "0123456789", Role = Role.Staff },
				new Staff { StaffID = "S0003", 	FirstName = "Vu",		LastName = "Mai Lan",		Gender = Gender.Female, Address = "Ha Noi",		Email = "lanvm@gmail.com",					Phone = "0123456787", Role = Role.Staff },
			};
